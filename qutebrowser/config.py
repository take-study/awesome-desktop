...
c.content.headers.user_agent = (
    "Mozilla/5.0 ({os_info}; rv:146.0) Gecko/20100101 Firefox/146.0"
)
...
config.bind(
    "pw", "spawn --userscript qute-keepassxc-local --key {{gpg-key}}", mode="normal"
)
config.bind(
    "<Alt-Shift-u>",
    "spawn --userscript qute-keepassxc-local --key {{gpg-key}}",
    mode="insert",
)
config.bind(
    "<Ctrl-Shift-p>",
    "spawn --userscript qute-keepassxc-local --totp --key {{gpg-key}}",
    mode="normal",
)
config.bind(
    "<Ctrl-Shift-t>",
...
config.bind("<Alt-p>", "spawn --userscript qute-keepassxc-local", mode="insert")
...
config.bind(
    "<Ctrl-Shift-t>",
    "spawn --userscript translate --target_lang {{translate_target}}",
    mode="caret",
)
